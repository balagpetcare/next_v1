...
const CORE_OWNER_FALLBACK: MenuItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { id: "owner.products.transfers", label: "Product Transfers (Legacy)", href: "/owner/transfers", required: [], deprecated: true },
    ],
  },
  ...
  owner: [
    ...
    },
    {
      ...
      children: [
        ...
        { id: "owner.products.transfers", label: "Product Transfers (Legacy)", href: "/owner/transfers", required: ["inventory.read"], deprecated: true },
      ],
    },
    { id: "owner.finance", label: "Finance", href: "/owner/finance", icon: "solar:wallet-outline", required: [] },
    { id: "owner.audit", label: "Audit & System", href: "/owner/audit", icon: "solar:shield-check-outline", required: [] },
