...
export const IMPLEMENTED_ADMIN_HREFS: Set<string> = new Set([
  ...
  '/admin/medicine-catalog-import',
  '/admin/medicine',
  '/admin/medicine/listings',
  '/admin/medicine/listings/new',
  '/admin/medicine/generics',
  '/admin/medicine/generics/new',
  '/admin/medicine/brands',
  '/admin/medicine/brands/new',
  '/admin/medicine/dosage-forms',
  '/admin/medicine/dosage-forms/new',
  '/admin/medicine/presentations',
  '/admin/medicine/presentations/new',
  '/admin/medicine/manufacturers',
  '/admin/medicine/manufacturers/new',
  '/admin/medicine/country-catalogs',
  '/admin/medicine/imports',
  '/admin/medicine/imports/new',
  '/admin/medicine/exports',
  '/admin/medicine/review',
  '/admin/medicine/settings',
