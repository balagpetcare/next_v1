'use client'
import comingSoonImg from '@larkon/assets/images/coming-soon.png'
import logoDark from '@larkon/assets/images/logo-dark.png'
import logoLight from '@larkon/assets/images/logo-light.png'
import smallImg from '@larkon/assets/images/small/img-10.jpg'
import useCountdown from '@larkon/hooks/useCountdown'
            ...
            <Row className="align-items-center justify-content-center h-100">
              <Col lg={8}>
                ...
                <div className="mx-auto text-center">
                  <Image src={comingSoonImg} alt="comingSoon" className="h-auto my-3" style={{ maxWidth: '80%' }} />
                </div>
                <Timer />
