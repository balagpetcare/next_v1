...
import { getSellersData } from '@larkon/helpers/data'
import { SellersType } from '@larkon/types/data'
...
export const metadata: Metadata = { title: 'Seller List' }

const SellersCard = ({ address, amount, category, clients, email, image, itemStock, phone, progress, rating, sells, title, url }: SellersType) => {
  return (
    <Card>
      <CardBody>
