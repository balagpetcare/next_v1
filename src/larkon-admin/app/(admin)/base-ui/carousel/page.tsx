...
import { Carousel as CarouselBootstrap, CarouselItem, Col, Container, Row } from 'react-bootstrap'
export const dynamic = 'force-dynamic'


import Img1 from '@larkon/assets/images/small/img-1.jpg'
import Img10 from '@larkon/assets/images/small/img-10.jpg'
import Img2 from '@larkon/assets/images/small/img-2.jpg'
import Img3 from '@larkon/assets/images/small/img-3.jpg'
import Img4 from '@larkon/assets/images/small/img-4.jpg'
import Img5 from '@larkon/assets/images/small/img-5.jpg'
import Img6 from '@larkon/assets/images/small/img-6.jpg'
import Img7 from '@larkon/assets/images/small/img-7.jpg'
import Img8 from '@larkon/assets/images/small/img-8.jpg'
import Img9 from '@larkon/assets/images/small/img-9.jpg'
    ...
    <ComponentContainerCard id="with-controls" title="With Controls" description={<>Adding in the previous and next controls:</>}>
      <div className="w-50 mb-3 mx-auto">
        <CarouselBootstrap indicators={false}>
          <CarouselItem>
            <Image src={Img4} height={302} className="d-block w-100" alt="img-2" />
          </CarouselItem>
          <CarouselItem>
            <Image src={Img2} height={302} className="d-block w-100" alt="img-3" />
          </CarouselItem>
          <CarouselItem>
            <Image src={Img3} height={302} className="d-block w-100" alt="img-4" />
          </CarouselItem>
        </CarouselBootstrap>
      </div>
    </ComponentContainerCard>
  ...
  return (
    <ComponentContainerCard
      ...
      <div className="mx-auto mb-3 w-50">
        <CarouselBootstrap>
          <CarouselItem>
            <Image src={Img5} height={302} className="d-block w-100" alt="img-5" />
          </CarouselItem>
          <CarouselItem>
            <Image src={Img6} height={302} className="d-block w-100" alt="img-6" />
          </CarouselItem>
          <CarouselItem>
            <Image src={Img7} height={302} className="d-block w-100" alt="img-7" />
          </CarouselItem>
        </CarouselBootstrap>
      </div>
    </ComponentContainerCard>
    ...
    <ComponentContainerCard
      ...
      <div className="mx-auto mb-3 w-50">
        <CarouselBootstrap indicators={false} fade>
          <CarouselItem>
            <Image src={Img1} height={302} className="d-block w-100" alt="img-2" />
          </CarouselItem>
          <CarouselItem>
            <Image src={Img2} height={302} className="d-block w-100" alt="img-3" />
          </CarouselItem>
    ...
    <ComponentContainerCard
      ...
      <div className="mx-auto mb-3 w-50">
        <CarouselBootstrap indicators={false} touch={false}>
          ...
          <CarouselItem>
            <Image src={Img5} height={302} className="d-block w-100" alt="img-3" />
          </CarouselItem>
          <CarouselItem>
            <Image src={Img6} height={302} className="d-block w-100" alt="img-4" />
          </CarouselItem>
        </CarouselBootstrap>
      </div>
    </ComponentContainerCard>
    ...
    <ComponentContainerCard
      ...
      <div className="mx-auto mb-3 w-50">
        <CarouselBootstrap className="carousel-dark">
          <CarouselItem interval={10000}>
            <Image height={302} src={Img8} className="d-block w-100" alt="..." />
            <div className="carousel-caption d-none d-md-block">
          ...
          <CarouselItem interval={2000}>
            <Image src={Img9} height={302} className="d-block w-100" alt="..." />
            <div className="carousel-caption d-none d-md-block">
          ...
          <CarouselItem>
            <Image src={Img10} height={302} className="d-block w-100" alt="..." />
            <div className="carousel-caption d-none d-md-block">
