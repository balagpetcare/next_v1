...
const BasicExample = () => {
  return (
    <ComponentContainerCard id="basic" title="Basic Example" description={'Set data-choices attribute to set a default single select.'}>
...
const MultipleSelectInput = () => {
  return (
    <ComponentContainerCard
      ...
      <div className="w-50 mb-3">
        <ChoicesFormInput className="form-control" id="choices-multiple-default" data-choices multiple defaultValue={['Choice 1']}>
    ...
    <ComponentContainerCard
      ...
      <div className="w-50 mb-3">
        <ChoicesFormInput
          ...
          multiple defaultValue={['Choice 1']}>
          <option value="Choice 1">
            Choice 1
          </option>
          <option value="Choice 2">Choice 2</option>
          ...
          <Col xl={3}>
            <UIExamplesList
              examples={[
                ...
                { link: '#disabled-values', label: 'Disabled Text Inputs' },
              ]}
            />
          </Col>
        </Row>
