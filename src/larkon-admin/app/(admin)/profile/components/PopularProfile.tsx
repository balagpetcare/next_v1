...
import { popularProfileData, PopularProfileType } from '../data'
import Link from 'next/link'

const PopularProfileCard = ({ date, description, name, questionTag, title }: PopularProfileType) => {
  return (
    <Card>
      <CardBody>
          ...
          <div>
            <h4 className="mb-1">
              ...
              <span className="fs-13 text-muted fw-medium ms-1">
                Project Head Manager . {date.toLocaleString('en-us', { month: 'short', day: 'numeric' })}
              </span>
            </h4>
            <p className="mb-0">
              Asked a question{' '}
