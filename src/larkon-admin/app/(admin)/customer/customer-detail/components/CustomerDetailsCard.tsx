...
import { customerDetailsCardDta, CustomerDetailsCardType } from '../data'
import IconifyIcon from '@larkon/components/wrappers/IconifyIcon'
import { Card, CardBody, CardTitle, Col } from 'react-bootstrap'

const CustomerDataCard = ({ icon, item, title }: CustomerDetailsCardType) => {
  return (
    <Card>
      <CardBody>
...
const CustomerDetailsCard = () => {
  return (
    <>
      {customerDetailsCardDta.map((item, idx) => (
        <Col lg={4} key={idx}>
