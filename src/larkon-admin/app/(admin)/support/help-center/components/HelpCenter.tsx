...
import smallImg from '@larkon/assets/images/small/img-2.jpg'
import { getHelpData } from '@larkon/helpers/data'
import { HelpType } from '@larkon/types/data'
import Image from 'next/image'
import { Card, CardBody, CardTitle, Col, Modal, ModalBody, ModalDialog, ModalFooter, ModalHeader, Row } from 'react-bootstrap'
import useToggle from '@larkon/hooks/useToggle'
import { useFetchData } from '@larkon/hooks/useFetchData'
...
const HelpBanner = () => {
  return (
    <Row className="justify-content-center">
      <Col lg={12}>
        <Card className="overflow-hidden" style={{ background: `url(${smallImg.src})` }}>
            ...
            <Row className="justify-content-center">
              <Col lg={7} className="text-center">
                ...
                <div className="search-bar">
                  ...
                  <LkInput type="search" className="rounded-pill bg-white border-0" id="search" placeholder="Search ..." />
                </div>
              </Col>
            </Row>
          </CardBody>
...
const HelpCard = ({ avatar, description, icon, name, title, video, toggle }: HelpType) => {
  return (
    <Card>
      <CardBody>
