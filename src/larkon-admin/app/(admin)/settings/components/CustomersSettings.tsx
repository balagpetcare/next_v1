      ...
      <Col lg={12}>
        <Card>
          ...
          <CardBody>
            ...
            <Row className="mt-3">
              <Col lg={6}>
                <LkFormGroup label="Max Login Attempts" htmlFor="login-attempts">
                  <LkInput type="text" id="login-attempts" className="radius-12" placeholder="max" defaultValue="1 hour" />
                </LkFormGroup>
              </Col>
            </Row>
          </CardBody>
