            ...
            <div className="modal-content">
              ...
              <form onSubmit={handleInviteSubmit}>
                <div className="modal-body">
                  ...
                  <LkFormGroup label="Email" className="mb-16">
                    <LkInput type="email" size="sm" className="radius-12" value={inviteForm.email} onChange={(e) => setInviteForm((f) => ({ ...f, email: e.target.value }))} placeholder="email@example.com" />
                  </LkFormGroup>
                  <LkFormGroup label="Phone (optional)" className="mb-16">
                    <LkInput type="text" size="sm" className="radius-12" value={inviteForm.phone} onChange={(e) => setInviteForm((f) => ({ ...f, phone: e.target.value }))} placeholder="+1234567890" />
                  </LkFormGroup>
                  <LkFormGroup label="Role" className="mb-16">
                    <LkSelect
                      size="sm"
                      className="radius-12"
