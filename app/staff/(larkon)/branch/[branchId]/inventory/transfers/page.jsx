            ...
            <div className="modal-content">
              ...
              <form onSubmit={handleCreateSubmit}>
                <div className="modal-body">
                  <LkFormGroup label="From (this branch)" className="text-sm mb-16">
                    <LkSelect
                      size="sm"
                      className="radius-12"
                  ...
                  <LkFormGroup label="To (other branch)" className="text-sm mb-16">
                    <LkSelect
                      size="sm"
                      className="radius-12"
                  ...
                  <span className="form-label text-sm d-block mb-8">Items</span>
