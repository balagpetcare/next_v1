...
type TierOpt = { id: number; name: string };
...
type Props = {
  ...
  memberPct: string;
  variantQuery: string;
  variantHits: { id: number; sku: string; title: string; product?: { name?: string } }[];
...
export function EnterpriseRuleSimulationPanel({
  orgId,
  branches,
  tiers,
  variantId,
    ...
    <div className="card radius-12 mb-3">
      <div className="card-body">
        <div className="d-flex flex-wrap justify-content-between align-items-start gap-2 mb-2">
          <div>
            <h6 className="card-title mb-1">Resolution preview</h6>
            <p className="small text-muted mb-0">
              Uses the same engine as checkout: catalog list price, then enterprise discount rules (by priority / stackable), campaigns,
              membership tier, then batch promo. Choose a branch and SKU to see how rules interact.
            </p>
          </div>
        </div>
                  ...
                  <>
                    <dl className="row small mb-2">
                      ...
                      {breakdown?.enterpriseList != null && (
                        <>
                          <dt className="col-5">After rules / campaigns</dt>
                    ...
                    <p className="small text-muted mb-1">
                      Lower rule priority runs first. When a rule is not stackable, the chain stops and later rules do not apply to list price.
                    </p>
