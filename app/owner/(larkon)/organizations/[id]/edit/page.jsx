...
import OrganizationWizardForm from "@/app/owner/(larkon)/organizations/_components/OrganizationWizardForm";
    ...
    <div className="container-fluid">
        ...
        >
          <div className="row g-3">
            <div className="col-md-6">
              <LkFormGroup label="Organization Name *" htmlFor="org-name">
                <LkInput
                  id="org-name"
                  value={basic.name}
            ...
            <div className="col-md-6">
              <LkFormGroup label="Organization Type *" htmlFor="org-type" error={typesError}>
                <LkSelect
                  id="org-type"
            ...
            <div className="col-md-6">
              <LkFormGroup label="Support Phone *" htmlFor="support-phone">
                <LkInput
                  id="support-phone"
            ...
            <div className="col-md-6">
              <LkFormGroup label="Support Email" htmlFor="support-email" error={fieldErrors.supportEmail}>
                <LkInput
                  id="support-email"
                  type="email"
            ...
            <div className="col-md-4">
              <LkFormGroup label="WhatsApp Number" htmlFor="whatsapp" error={fieldErrors.whatsappNumber}>
                <LkInput
                  id="whatsapp"
            ...
            <div className="col-md-4">
              <LkFormGroup label="Alternate Phone" htmlFor="alternate-phone" error={fieldErrors.alternatePhone}>
                <LkInput
                  id="alternate-phone"
                    ...
                    <div className="row g-3">
                      <div className="col-md-6">
                        <LkFormGroup label="Vet License Number">
                          <LkInput className="radius-12" value={typeSpecific.vetLicenseNumber || ""} onChange={(e) => setTypeSpecific({...typeSpecific, vetLicenseNumber: e.target.value})} placeholder="Veterinary license number" />
                        </LkFormGroup>
                      </div>
                      <div className="col-md-6">
                        <LkFormGroup label="Emergency Contact">
                          <LkInput className="radius-12" value={typeSpecific.emergencyContact || ""} onChange={(e) => setTypeSpecific({...typeSpecific, emergencyContact: e.target.value})} placeholder="Emergency contact number" />
                        </LkFormGroup>
                      </div>
                      <div className="col-md-12">
                        <LkFormGroup label="Specializations">
                          <LkInput className="radius-12" value={typeSpecific.specializations || ""} onChange={(e) => setTypeSpecific({...typeSpecific, specializations: e.target.value})} placeholder="e.g., Surgery, Vaccination, Grooming" />
                        </LkFormGroup>
                      </div>
                      <div className="col-md-12">
                        <LkFormGroup label="Services Offered">
                          <LkTextarea className="radius-12" rows={3} value={typeSpecific.services || ""} onChange={(e) => setTypeSpecific({...typeSpecific, services: e.target.value})} placeholder="List services offered (one per line)" />
                        </LkFormGroup>
                      </div>
                    </div>
                    ...
                    <div className="row g-3">
                      <div className="col-md-6">
                        <LkFormGroup label="Store Hours">
                          <LkInput className="radius-12" value={typeSpecific.storeHours || ""} onChange={(e) => setTypeSpecific({...typeSpecific, storeHours: e.target.value})} placeholder="e.g., 9 AM - 9 PM" />
                        </LkFormGroup>
                      </div>
                      <div className="col-md-6">
                        <LkFormGroup label="Delivery Available">
                          <LkSelect className="radius-12" value={typeSpecific.deliveryAvailable || ""} onChange={(e) => setTypeSpecific({...typeSpecific, deliveryAvailable: e.target.value})}>
                      ...
                      <div className="col-md-12">
                        <LkFormGroup label="Product Categories Focus">
                          <LkInput className="radius-12" value={typeSpecific.productCategories || ""} onChange={(e) => setTypeSpecific({...typeSpecific, productCategories: e.target.value})} placeholder="e.g., Food, Toys, Accessories" />
                        </LkFormGroup>
                      </div>
                      <div className="col-md-12">
                        <LkFormGroup label="Online Store URL">
                          <LkInput className="radius-12" value={typeSpecific.onlineStoreUrl || ""} onChange={(e) => setTypeSpecific({...typeSpecific, onlineStoreUrl: e.target.value})} placeholder="e.g., https://shop.example.com" />
                        </LkFormGroup>
                      </div>
                    </div>
                    ...
                    <div className="row g-3">
                      <div className="col-md-6">
                        <LkFormGroup label="Platform Website">
                          <LkInput className="radius-12" value={typeSpecific.platformUrl || ""} onChange={(e) => setTypeSpecific({...typeSpecific, platformUrl: e.target.value})} placeholder="Main platform URL" />
                        </LkFormGroup>
                      </div>
                      <div className="col-md-6">
                        <LkFormGroup label="Social Media Links">
                          <LkInput className="radius-12" value={typeSpecific.socialMedia || ""} onChange={(e) => setTypeSpecific({...typeSpecific, socialMedia: e.target.value})} placeholder="Comma-separated URLs" />
                        </LkFormGroup>
                      </div>
                      <div className="col-md-6">
                        <LkFormGroup label="Delivery Coverage Areas">
                          <LkInput className="radius-12" value={typeSpecific.deliveryCoverage || ""} onChange={(e) => setTypeSpecific({...typeSpecific, deliveryCoverage: e.target.value})} placeholder="e.g., Dhaka, Chittagong" />
                        </LkFormGroup>
                      </div>
                      <div className="col-md-3">
                        <LkFormGroup label="Minimum Order Value (BDT)">
                          <LkInput type="number" className="radius-12" value={typeSpecific.minOrderValue || ""} onChange={(e) => setTypeSpecific({...typeSpecific, minOrderValue: e.target.value})} placeholder="0" />
                        </LkFormGroup>
                      </div>
                      <div className="col-md-3">
                        <LkFormGroup label="Delivery Charge (BDT)">
                          <LkInput type="number" className="radius-12" value={typeSpecific.deliveryCharge || ""} onChange={(e) => setTypeSpecific({...typeSpecific, deliveryCharge: e.target.value})} placeholder="0" />
                        </LkFormGroup>
                      </div>
                    </div>
                  ) : null}
      ...
      {step === 2 ? (
        ...
        >
          <div className="row g-3">
            ...
            <div className="col-md-6">
              <LkFormGroup label="Official Phone" error={fieldErrors.officialPhone}>
                <LkInput
                  error={!!fieldErrors.officialPhone}
                  className="radius-12"
            ...
            <div className="col-md-6">
              <LkFormGroup label="Official Email" error={fieldErrors.officialEmail}>
                <LkInput
                  type="email"
            ...
            <div className="col-md-6">
              <LkFormGroup label="Website" error={fieldErrors.website}>
                <LkInput
            ...
            <div className="col-md-6">
              <LkFormGroup label="Facebook Page" error={fieldErrors.facebookPage}>
                <LkInput
      ...
      {step === 3 ? (
        <Card title="Documents & Directors" subtitle="Replace documents and update directors/partners">
          <div className="row g-3">
            <div className="col-md-6">
              <LkFormGroup label="Trade License Document *">
                <LkFileUpload
                  disabled={busy}
            ...
            <div className="col-12">
              ...
              {replacingDoc ? (
                <div className="mt-12 border radius-12 p-12">
                  ...
                  <LkFormGroup label="Select new file" className="mt-2">
                    <LkFileUpload
                      disabled={replaceBusy}
                      onChange={(e) => {
