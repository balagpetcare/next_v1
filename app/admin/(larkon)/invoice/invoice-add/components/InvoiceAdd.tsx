...
const CustomFlatpickr = dynamic(() => import('@larkon/components/CustomFlatpickr'), { ssr: false })
const ChoicesFormInput = dynamic(() => import('@larkon/components/form/ChoicesFormInput'), { ssr: false })
