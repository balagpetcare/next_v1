import checkImg from '@larkon/assets/images/check-2.png'
            ...
            <CardBody>
              ...
              <div className="mt-3 mb-1">
                <div className="text-end d-print-none">
                  <Link href="javascript:window.print()" className="btn btn-info width-xl">
                    Print
                  </Link>
                  &nbsp;
                  <Link href="#" className="btn btn-outline-primary width-xl">
                    Submit
                  </Link>
                </div>
              </div>
