            ...
            <Col md={6}>
              <form action="#">
                <div className="mb-3">
                  ...
                  <InputMask mask={[/\d/, /\d/, '/', /\d/, /\d/, '/', /\d/, /\d/, /\d/, /\d/]} placeholder="__/__/___" className="form-control" />
                ...
                <div className="mb-3">
                  ...
                  <InputMask mask={[/\d/, /\d/, ':', /\d/, /\d/, ':', /\d/, /\d/]} placeholder="__:__:__" className="form-control" />
                ...
                <div className="mb-3">
                  ...
                  <InputMask mask={[/\d/, /\d/, /\d/, /\d/, /\d/, '-', /\d/, /\d/, /\d/]} placeholder="____-__" className="form-control" />
                ...
                <div className="mb-3">
                  ...
                  <InputMask mask={[/\d/, '-', /\d/, /\d/, '-', /\d/, /\d/, '-', /\d/, /\d/]} placeholder="_-__-__-__" className="form-control" />
                ...
                <div className="mb-3">
                  ...
                  <InputMask mask={[/\d/, '.', /\d/, /\d/, /\d/, ',', /\d/, /\d/]} placeholder="#.##0,00" className="form-control" />
            ...
            <Col md={6}>
              <form action="#">
                <div className="mb-3">
                  ...
                  <InputMask mask={[/[1-9]/, /\d/, /\d/, /\d/, '-', /\d/, /\d/, /\d/, /\d/]} placeholder="____-____" className="form-control" />
