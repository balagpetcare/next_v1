...
import { Accordion, AccordionBody, AccordionHeader, AccordionItem, Alert, Card, CardBody, CardHeader, CardTitle, Col, Row } from 'react-bootstrap'
import Image from 'next/image'
import BrandDhlImg from '@larkon/assets/images/brands/dhl.png'
import fedex from '@larkon/assets/images/brands/fedex.png'
import brandUpsImg from '@larkon/assets/images/brands/ups.png'
import paypalImg from '@larkon/assets/images/card/paypal.svg'
import mastercardImg from '@larkon/assets/images/card/mastercard.svg'
import stripeImg from '@larkon/assets/images/card/stripe.svg'
import visaCardImg from '@larkon/assets/images/card/visa.svg'
import ChoicesFormInput from '@larkon/components/form/ChoicesFormInput'
import { currency } from '@larkon/context/constants'
    ...
    <Col lg={8}>
      <Card>
        <CardBody>
          <Row>
            <Col lg={3}>
              <CardTitle as={'h4'}>Personal Details</CardTitle>
            </Col>
            <Col lg={9}>
              <Row>
                <Col lg={6}>
                ...
                <Col lg={6}>
                  <form>
                    <div className="mb-3">
                      ...
                      <input type="email" id="your-email" className="form-control" placeholder="Email" />
                    </div>
                  </form>
                </Col>
                <Col lg={6}>
                  <form>
                    <div className="mb-3">
                      ...
                      <input type="number" id="your-number" name="your-number" className="form-control" placeholder="Number" />
                    </div>
                  </form>
                </Col>
              </Row>
          ...
          <div className="mt-3">
            <Row>
              <Col lg={3}>
                <CardTitle as={'h4'}>Shipping Details</CardTitle>
              </Col>
              <Col lg={9}>
                <Row>
                  <Col lg={12}>
                    ...
                    <form>
                      <div className="mb-3">
                        ...
                        <textarea className="form-control" id="your-address" rows={3} placeholder="Enter address" defaultValue={''} />
                      </div>
                    </form>
                  </Col>
                  <Col lg={4}>
                        ...
                        <div className="d-flex align-items-center p-2 rounded gap-2 border">
                          <div className="d-flex align-items-center gap-2">
                            <div className="rounded-3 bg-light avatar-md d-flex align-items-center justify-content-center">
                              <Image src={BrandDhlImg} alt="BrandDhlImg" className="avatar rounded" />
                            </div>
                            <div>
                              <h5 className="text-dark fw-medium">DHL Fast Services</h5>
                              <p className="mb-0 text-dark">
                                Delivery -<span className="text-muted fw-normal">Today</span>
                              </p>
                            </div>
                          </div>
                          <div className="ms-auto">
                            <p className="mb-2">{currency}10.00</p>
                            <input className="form-check-input float-end" type="radio" name="shipping" id="shipping-1" />
                          </div>
                        </div>
                      </label>
                    </div>
                    ...
                    <div className="form-check form-checkbox-primary ps-0">
                      <label htmlFor="shipping-2" className="w-100">
                        <div className="d-flex align-items-center p-2 rounded gap-2 border">
                          <div className="d-flex align-items-center gap-2">
                            <div className="rounded-3 bg-light avatar-md d-flex align-items-center justify-content-center">
                              <Image src={fedex} alt="fedex" className="avatar rounded" />
                            </div>
                            <div>
                              <h5 className="text-dark fw-medium">FedEx Services</h5>
                              <p className="mb-0 text-dark">
                                Delivery -<span className="text-muted fw-normal">Today</span>
                              </p>
                            </div>
                          ...
                          <div className="ms-auto">
                            <p className="mb-2">{currency}10.00</p>
                            <input className="form-check-input float-end" type="radio" name="shipping" id="shipping-2" />
                          </div>
                        </div>
                      </label>
                    </div>
                    ...
                    <div className="form-check form-checkbox-primary ps-0">
                      <label htmlFor="shipping-3" className="w-100">
                        <div className="d-flex align-items-center p-2 rounded gap-2 border">
                          <div className="d-flex align-items-center gap-2">
                            <div className="rounded-3 bg-light avatar-md d-flex align-items-center justify-content-center">
                              <Image src={brandUpsImg} alt="brandUpsImg" className="avatar rounded" />
                            </div>
                            <div>
                              <h5 className="text-dark fw-medium">UPS Services</h5>
                              <p className="mb-0 text-dark">
                                Delivery -<span className="text-muted fw-normal">Tomorrow</span>
                              </p>
                            </div>
                          </div>
                          <div className="ms-auto">
                            <p className="mb-2">{currency}8.00</p>
                            <input className="form-check-input float-end" type="radio" name="shipping" id="shipping-3" />
                          </div>
                        </div>
                      </label>
                    </div>
                    ...
                    <div className="form-check form-checkbox-primary ps-0">
                      <label htmlFor="shipping-4" className="w-100">
                        <div className="d-flex align-items-center p-2 rounded gap-2 border">
                          <div className="d-flex align-items-center gap-2">
                            <div className="rounded-3 bg-light avatar-md d-flex align-items-center justify-content-center">
                              <IconifyIcon icon="solar:box-bold-duotone" className="fs-36 text-warning" />
                            </div>
                            <div>
                              <h5 className="text-dark fw-medium">Our Courier Services</h5>
                              <p className="mb-0 text-dark">
                                Delivery -<span className="text-muted fw-normal">25 Apr 2024</span>
                              </p>
                            </div>
                          </div>
                          <div className="ms-auto">
                            <p className="mb-2">{currency}0.00</p>
                            <input className="form-check-input float-end" type="radio" name="shipping" id="shipping-4" defaultChecked />
                          </div>
                        </div>
                      </label>
                    </div>
          ...
          <div className="mt-5">
            <Row>
              <Col lg={3}>
                <CardTitle as={'h4'}>Payment Method</CardTitle>
              </Col>
              <Col lg={9}>
                <Card className="border-0">
                  <Accordion defaultActiveKey="1" id="accordionExample">
                    <Card>
                      <AccordionItem eventKey="1" aria-labelledby="pay-pal" data-bs-parent="#accordionExample">
                        <CardHeader className="p-0" id="pay-pal">
                          <AccordionHeader className="mb-0">
                            <div className="rounded-0 rounded-top-1">
                              <div className="d-flex align-items-center justify-content-between">
                                <span className="fs-5">Paypal</span>
                                <Image src={paypalImg} alt="paypalImg" className="avatar-sm" />
                              </div>
                            </div>
                          </AccordionHeader>
                          <p className="p-3 mb-0">Safe Payment Online Credit card needed. PayPal account is not necessary</p>
                        </CardHeader>
                        <AccordionBody>
                          <CardBody>
                          ...
                          <button
                            ...
                            <div className="d-flex align-items-center justify-content-between">
                              ...
                              <div className="icons text-end">
                                <Image src={mastercardImg} alt="mastercard" className="avatar-sm" />
                                <Image src={stripeImg} alt="stripeCard" className="avatar-sm" />
                                <Image src={visaCardImg} alt="visaCardImg" className="avatar-sm" />
                              </div>
                            </div>
                          </button>
                        </h2>
                        <p className="p-3 mb-0">Safe Money Transfer using your bank account. Visa , Master Card ,Discover , American Express</p>
                      </CardHeader>
                      <div id="collapseOne" className="collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                        <div className="p-3">
                          ...
                          <Row>
                            <Col md={6}>
                              <div className="mb-3">
                                <label htmlFor="ex-date" className="form-label">
                                  Expiry Date
                                </label>
                                <input type="text" id="ex-date" className="form-control flatpickr-input" placeholder="dd-mm-yyyy" required />
                              </div>
                            </Col>
                            <Col md={6}>
                              <div className="mb-3">
                          ...
                          <Alert className="alert-success mb-0 d-flex align-items-center gap-2" role="alert">
                            <IconifyIcon icon="solar:shield-check-bold" className="fs-28 align-middle" />
...
const PromoCard = () => {
  return (
    <Card className="text-center bg-primary overflow-hidden z-1">
          ...
          <Card>
            <CardBody>
              <div className="d-flex gap-3">
                ...
                <div>
                  <h5 className="text-white fw-medium mb-1">Streaming box shipping information</h5>
              ...
              <div className="d-flex align-items-center gap-3 mt-4">
                <div className="rounded-3 bg-light flex-shrink-0 avatar d-flex align-items-center justify-content-center">
                  <IconifyIcon icon="solar:wallet-money-bold-duotone" className="fs-36 text-success" />
                </div>
                <div>
                  <h5 className="text-white fw-medium mb-1">30 Day money back guarantee</h5>
                  <p className="text-white-50 mb-0">Money Return In 30 day In Your Bank Account</p>
                </div>
              </div>
            </CardBody>
          </Card>
