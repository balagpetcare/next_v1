...
export default function CountryFeaturesPage() {
  ...
  const onSave = async () => {
    ...
    setError('')
    try {
      await apiPut(`/api/v1/admin/country/policies/${policyId}/features`, { features })
      await load()
    } catch (e) {
  ...
  return (
    <AdminPageShell
      ...
      breadcrumbs={[{ label: 'Geography' }, { label: 'Countries', href: '/admin/countries' }, { label: `#${countryId}` }, { label: 'Features' }]}
      actions={
