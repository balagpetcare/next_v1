  ...
  return (
    <Card>
      ...
      <CardBody className="bg-light-subtle rounded-bottom">
        <Link href={`/products/${id}`} className="text-dark fw-medium fs-16">
          {title}
        </Link>
        <div className="my-1">
