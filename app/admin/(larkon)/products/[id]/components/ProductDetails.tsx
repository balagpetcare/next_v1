...
import product10 from '@larkon/assets/images/product/p-10.png'
import product13 from '@larkon/assets/images/product/p-13.png'
import product14 from '@larkon/assets/images/product/p-14.png'
              ...
              <div className="carousel-indicators m-0 mt-2 d-lg-flex d-none position-static h-100">
                {products.map((item, idx) => (
                  <button
                    ...
                    aria-current="true"
                    id="Slide-1"
                    className={clsx('w-auto h-auto rounded bg-light', { active: activeIndex === idx })}>
