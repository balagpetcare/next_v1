...
import avatar3 from '@larkon/assets/images/users/avatar-3.jpg'
import avatar4 from '@larkon/assets/images/users/avatar-4.jpg'
import avatar5 from '@larkon/assets/images/users/avatar-5.jpg'
import avatar6 from '@larkon/assets/images/users/avatar-6.jpg'
import avatar7 from '@larkon/assets/images/users/avatar-7.jpg'
import avatar8 from '@larkon/assets/images/users/avatar-8.jpg'
import avatar9 from '@larkon/assets/images/users/avatar-9.jpg'
...
const ImagesShapes = () => {
  return (
    <ComponentContainerCard id="images-shapes" title="Images Shapes" description={<>Avatars with different sizes and shapes.</>}>
