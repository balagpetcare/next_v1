import { colorVariants } from '@larkon/context/constants'
...
import cardImg from '@larkon/assets/images/small/img-1.jpg'
import cardImg2 from '@larkon/assets/images/small/img-2.jpg'
import cardImg3 from '@larkon/assets/images/small/img-3.jpg'
import cardImg4 from '@larkon/assets/images/small/img-4.jpg'
import cardImg5 from '@larkon/assets/images/small/img-5.jpg'
      ...
      {colorVariants.slice(0, 3).map((color, idx) => (
        <Col md={4} key={idx}>
          <Card className={`border-${color} border`}>
            <CardBody>
              <CardTitle as={'h5'} className={`card-title text-${color} mb-2`}>
                Special title treatment
              </CardTitle>
