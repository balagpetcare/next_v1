...
import { kebabToTitleCase } from '@larkon/utils/change-casing'
    ...
    <ComponentContainerCard id="basic" title="Basic Toastify JS Example" titleClass="mb-3">
      <div className="hstack flex-wrap gap-2">
        ...
        <Button
          variant="light"
          type="button"
          onClick={() => toastify({ message: 'Your application was successfully sent', props: { type: 'success', position: 'top-center' } })}
          className=" w-xs">
          Success
        </Button>
        <Button
          variant="light"
          type="button"
          onClick={() => toastify({ message: 'Warning ! Something went wrong try again', props: { type: 'warning', position: 'top-center' } })}
          className=" w-xs">
          Warning
        </Button>
        <Button
          variant="light"
          type="button"
          onClick={() => toastify({ message: 'Error ! An error occurred.', props: { type: 'error', position: 'top-center' } })}
          className=" w-xs">
          Error
        </Button>
      </div>
