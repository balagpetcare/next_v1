...
import { getAllEmails } from '@larkon/helpers/data'
import type { EmailType } from '@larkon/types/data'
...
const Inbox = () => {
  ...
  return (
    <TabPane eventKey="Inbox" className="fade" role="tabpanel">
      <div>
        <Nav variant="underline" justify>
          <NavItem>
            <NavLink
              as="span"
              role="button"
              className={clsx('d-flex align-items-center px-3', { active: activeLabel === 'Primary' })}
          ...
          <NavItem>
            <NavLink
              as="span"
              role="button"
              className={clsx('d-flex align-items-center px-3', { active: activeLabel === 'Social' })}
          ...
          <NavItem>
            <NavLink
              as="span"
              role="button"
              className={clsx('d-flex align-items-center px-3', { active: activeLabel === 'Promotions' })}
          ...
          <NavItem>
            <NavLink
              as="span"
              role="button"
              className={clsx('d-flex align-items-center px-3', { active: activeLabel === 'Updates' })}
          ...
          <NavItem>
            <NavLink
              as="span"
              role="button"
              className={clsx('d-flex align-items-center px-3', { active: activeLabel === 'Forums' })}
        ...
        <TabContainer activeKey={activeLabel}>
          {!!emails?.length && (
            <TabContent className="text-muted pt-0">
