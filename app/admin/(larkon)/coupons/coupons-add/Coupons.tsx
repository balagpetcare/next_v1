'use client'
import CustomFlatpickr from '@larkon/components/CustomFlatpickr'
            ...
            <CardBody>
              <form>
                <div className="mb-3">
                  ...
                  <CustomFlatpickr className="form-control flatpickr-input active" placeholder="dd-mm-yyyy" options={{ enableTime: false }} />
                </div>
              </form>
              <form>
                <div className="mb-3">
